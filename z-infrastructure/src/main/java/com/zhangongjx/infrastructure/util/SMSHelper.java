...
public class SMSHelper {
    ...
    @Value("#{conf.sms_accessKeyId}")
    private String accessKeyId;
    @Value("#{conf.sms_accessKeySecret}")
    private String accessKeySecret;

    public SendSmsResponse sendSms(String phone, String sign, String template, String param) throws ClientException {
