    ...
    switch(type){
        ...
        case 'tab':
            ...
            layer.tab({
                ...
                data: [{
                    title: '博客', 
                    content: tabIframe('http://www.baidu.com/?nowap')
                }, {
                    title: 'Belite主题', 
                    content: tabIframe('http://www.baidu.com')
                }, {
                    title: 'H+后台主题', 
...
window.paysentsin = function(){
    return $.layer({
        ...
        page: {html: '<images src="http://res.sentsin.com/images/pay.png">'},
        shadeClose: true
    });
};
