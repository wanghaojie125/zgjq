...
@Mapper
@Repository
public interface IGoodsSkuRepository {
    ...
    int getCount();
    @Insert("insert into s_user(user_name,pass_word,email,remark,dep_name,dep_id,real_name) VALUES(#{user_name}, #{pass_word},#{email},#{remark},#{dep_name},#{dep_id},#{real_name})")
